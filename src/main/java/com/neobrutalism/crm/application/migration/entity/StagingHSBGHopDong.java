...
/**
 * Staging entity for HSBG_theo_hop_dong sheet
 */
@Entity
@Table(name = "staging_hsbg_hop_dong")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class StagingHSBGHopDong {
