package com.neobrutalism.crm.domain.contract.model;
...
/**
 * Master data entity for contract/loan information
 * Receives transformed data from migration staging tables (HopDong records)
 */
@Entity
@Table(name = "contracts", 
    indexes = {
        ...
        @Index(name = "idx_contract_customer_cif", columnList = "customer_cif"),
        @Index(name = "idx_contract_due_date", columnList = "due_date"),
        @Index(name = "idx_contract_status", columnList = "pdm_case_status"),
        @Index(name = "idx_contract_box_code", columnList = "box_code")
    })
@Data
@Builder
@NoArgsConstructor
...
public class Contract {
    ...
    @Column(name = "customer_cif", nullable = false, length = 100)
    ...
    @Column(name = "expected_destruction_date")
    ...
    // Additional codes
    @Column(name = "dao_code", length = 100)
    private String daoCode;
    
    @Column(name = "ts_code", length = 100)
    private String tsCode;
    
    @Column(name = "rrt_id", length = 100)
