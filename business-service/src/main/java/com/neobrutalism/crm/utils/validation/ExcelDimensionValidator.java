package com.neobrutalism.crm.utils.validation;
...
public class ExcelDimensionValidator {
     ...
     * Made public for use by ExcelMetadataParser
     */
    public static java.util.Map<String, DimensionInfo> readAllSheetDimensions(InputStream inputStream) throws Exception {
